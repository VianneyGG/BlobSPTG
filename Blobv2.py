...
def Blob(Graphe: np.array, Terminaux: list, A: int = 1, B: int = 3000, alpha: float = 0.15, mu: float = 1, delta: float = 0.2, epsilon: float = 1e-3, débitEntrant: float = 1, positions: dict = {}, display_result: bool = True, step_callback=None) -> np.array:
